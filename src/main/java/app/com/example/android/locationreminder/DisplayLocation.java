...
public class DisplayLocation extends AppCompatActivity {
    ...
    public void edit(View v) {
        ...
        if(!gps_enabled && !network_enabled){
            android.app.AlertDialog.Builder alertDialogBuilder = new android.app.AlertDialog.Builder(DisplayLocation.this);
            alertDialogBuilder.setTitle("Info");
            alertDialogBuilder.setMessage("Turn on Location and data before editing current location");
        ...
        if (event.getAction() == KeyEvent.ACTION_DOWN) {
            switch (keyCode) {
                case KeyEvent.KEYCODE_BACK:
                    Intent i= new Intent(DisplayLocation.this,MainActivity.class);
                    startActivity(i);
            }
